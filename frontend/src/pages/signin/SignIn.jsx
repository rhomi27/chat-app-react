        ...
        <div className="w-full h-full flex justify-center items-center">
            <div className="w-96 h-auto relative bg-white shadow-sm shadow-sky-200 bg-opacity-5 rounded-md backdrop-blur-lg">
                <div className="p-4 sm:pr-28 transition-all duration-300">
                    <h1 className="text-2xl text-white font-bold text-center mb-8">Sign In <span className="text-sky-500">ChatApp</span></h1>
                    <form onSubmit={handleSubmit} className="flex flex-col gap-y-3">
                        ...
                        <Link to={'/signup'} className="text-white text-xs text-start hover:text-blue-600 p-1 underline">don't have a account? Sign Up</Link>
                        <button disabled={loading} className="w-full bg-blue-600 text-white mt-5 bg-opacity-50 p-1 border border-blue-600 text-sm rounded-md mb-5 hover:scale-[.98] transition-all duration-200">
                            {!loading ? "Sign In" : <div className="flex justify-center items-center w-full" role="status">
                ...
                <div className="absolute -z-[3] md:z-0 -right-28 top-0 transition-all duration-300  drop-shadow-md shadow-black">
